...
! function(global) {
    ...
    function newContext(e) {
        ...
        function r(e, r, i) {
            var n, o, a, s, u, c, p, d, f, l, h, m, g = r && r.split("/"),
                v = w.map,
                b = v && v["*"];
            if (e && (e = e.split("/"), p = e.length - 1, w.nodeIdCompat && jsSuffixRegExp.test(e[p]) && (e[p] = e[p].replace(jsSuffixRegExp, "")), "." === e[0].charAt(0) && g && (m = g.slice(0, g.length - 1), e = m.concat(e)), t(e), e = e.join("/")), i && v && (g || b)) {
                a = e.split("/");
                    ...
                    if (c = a.slice(0, s).join("/"), g)
                        for (u = g.length; u > 0; u -= 1)
                            if (o = getOwn(v, g.slice(0, u).join("/")), o && (o = getOwn(o, c))) {
                                d = o, f = s;
                                break e
                            }!l && b && getOwn(b, c) && (l = getOwn(b, c), h = s)
                }!d && l && (d = l, f = h), d && (a.splice(0, f, d), e = a.join("/"))
            }
        ...
        function a(e, t, i, n) {
            var a, s, u, c, p = null,
                ...
                l = !0,
                h = "";
            return e || (l = !1, e = "_@r" + (T += 1)), c = o(e), p = c[0], e = c[1], p && (p = r(p, d, n), s = getOwn(O, p)), e && (p ? h = s && s.normalize ? s.normalize(e, function(e) {
                return r(e, d, n)
            }) : -1 === e.indexOf("!") ? r(e, d, n) : e : (h = r(e, d, n), c = o(h), p = c[0], h = c[1], i = !0, a = q.nameToUrl(h))), u = !p || s || i ? "" : "_unnormalized" + (A += 1), {
                prefix: p,
                name: h,
                parentMap: t,
                unnormalized: !!u,
        ...
        function u(e, t, r) {
            var i = e.id,
                n = getOwn(S, i);
            !hasProp(O, i) || n && !n.defineEmitComplete ? (n = s(e), n.error && "error" === t ? r(n.error) : n.on(t, r)) : "defined" === t && r(O[i])
        }
        ...
        function f(e, t, r) {
            ...
            e.error ? e.emit("error", e.error) : (t[i] = !0, each(e.depMaps, function(i, n) {
                var o = i.id,
                    a = getOwn(S, o);
                !a || e.depMatched[n] || r[o] || (getOwn(t, o) ? (e.defineDep(n, O[o]), e.check()) : f(a, t, r))
            }), r[i] = !0)
        }
        ...
        function l() {
            var e, t, r = 1e3 * w.waitSeconds,
                ...
                p = !0;
            if (!b) {
                if (b = !0, eachProp(j, function(e) {
                        var r = e.map,
                            c = r.id;
                        if (e.enabled && (r.isDefine || s.push(e), !e.error))
                            if (!e.inited && o) n(c) ? (t = !0, u = !0) : (a.push(c), i(c));
                            else if (!e.inited && e.fetched && r.isDefine && (u = !0, !r.prefix)) return p = !1
        ...
        return E = {
            ...
            load: function() {
                var e = this.map.url;
                C[e] || (C[e] = !0, q.load(this.map.id, e))
            },
            check: function() {
                    ...
                    if (this.inited) {
                        if (this.error) this.emit("error", this.error);
                            ...
                            if (this.defining = !0, this.depCount < 1 && !this.defined) {
                                ...
                                if (this.exports = n, this.map.isDefine && !this.ignore && (O[r] = n, req.onResourceLoad)) {
                                    var s = [];
            ...
            callPlugin: function() {
                ...
                this.depMaps.push(i), u(i, "defined", bind(this, function(i) {
                    var n, o, p, f = getOwn(P, this.map.id),
                        l = this.map.name,
                    ...
                    return this.map.unnormalized ? (i.normalize && (l = i.normalize(l, function(e) {
                    ...
                    })), p = getOwn(S, o.id), void(p && (this.depMaps.push(o), this.events.error && p.on("error", bind(this, function(e) {
                        this.emit("error", e)
                        ...
                        var o = e.name,
                            u = a(o),
                            p = useInteractive;
                        i && (r = i), p && (useInteractive = !1), s(u), hasProp(w.config, t) && (w.config[o] = w.config[t]);
                        try {
                            req.exec(r)
                        } catch (d) {
                            return c(makeError("fromtexteval", "fromText eval for " + t + " failed: " + d, d, [t]))
                        }
                        p && (useInteractive = !0), this.depMaps.push(u), q.completeLoad(o), m([o], n)
            ...
            configure: function(e) {
                ...
                eachProp(e, function(e, t) {
                    ...
                    isArray(e) && (e = {
                        deps: e
                    }), !e.exports && !e.init || e.exportsFn || (e.exportsFn = q.makeShimExports(e)), t[r] = e
            ...
            makeRequire: function(t, n) {
                function o(r, i, u) {
                    var p, d, f;
                    return n.enableBuildCallback && i && isFunction(i) && (i.__requireJsBuild = !0), "string" == typeof r ? isFunction(i) ? c(makeError("requireargs", "Invalid require call"), u) : t && hasProp(E, r) ? E[r](S[t.id]) : req.get ? req.get(q, r, t, o) : (d = a(r, t, !1, !0), p = d.id, hasProp(O, p) ? O[p] : c(makeError("notloaded", 'Module name "' + p + '" has not been loaded yet for context: ' + e + (t ? "" : ". Use require([])")))) : (v(), q.nextTick(function() {
                        v(), f = s(a(null, t)), f.skipMap = n.skipMap, f.init(r, i, u, {
                            enabled: !0
                        }), l()
                    }), o)
                }
                return n = n || {}, mixin(o, {
                    ...
                    specified: function(e) {
                        return e = a(e, t, !1, !0).id, hasProp(O, e) || hasProp(S, e)
                    }
                }), t || (o.undef = function(e) {
                    p();
                    var r = a(e, t, !0),
                        n = getOwn(S, e);
                    n.undefed = !0, i(e), delete O[e], delete C[r.url], delete M[e], eachReverse(k, function(t, r) {
                        t[0] === e && k.splice(r, 1)
                    }), delete q.defQueueMap[e], n && (n.events.defined && (M[e] = n.events), d(e))
                }), o
            },
            enable: function(e) {
                var t = getOwn(S, e.id);
            ...
            completeLoad: function(e) {
                ...
                if (q.defQueueMap = {}, i = getOwn(S, e), !t && !hasProp(O, e) && i && !i.inited) {
            ...
            nameToUrl: function(e, t, r) {
                var i, n, o, a, s, u, c, p = getOwn(w.pkgs, e);
                if (p && (e = p), c = getOwn(P, e)) return q.nameToUrl(c, t, r);
...
function(e, t) {
    ...
    for (var i in r.paths) r.paths.hasOwnProperty(i) && "string" == typeof r.paths[i] && (r.paths[i] = [r.paths[i], r.paths[i]]);
    e.config(r)
}(require, define);
var compSupport = function() {
    ...
    function r(e) {
        for (var t = e.replace(/\s/g, "").split(","), r = 0; t.length > r; r++) require(["css!" + f + t[r]])
    }

    function i(e) {
        return e.match(/((\w+)(?=,|$)+)/g).join(" ")
    }

    function n(e, n, c, p, d) {
        if (!e) throw "[compSupport] Error jsName is empty";
        var f = window.performance && performance.now ? performance.now() : 0,
            l = s++,
            h = n.getAttribute("id") || "jcomp-" + l;
        return null !== n.getAttribute(u) ? !1 : (n.setAttribute("id", h), n.setAttribute(u, l), a[l] = {
            domId: h,
            jsName: e,
            status: "loading"
        }, a[l].info = d || "", require(["jquery"], function(t) {
            t(n).addClass(i(e)), p && (t(n).addClass(i(p)), r(p))
        }), void require([e], function(e) {
            a[l].status = "ok", f && (a[l]["loadingTime (ms)"] = Math.round(performance.now() - f)), o[l] = t(e), o[l].init(h, c), compSupport.triggerCompEvent(n, "init", [o[l]])
        }, function(e) {
            if (a[l].status = "error", e.requireModules) {
                var t = "[compSupport] Error loading JS modules: " + e.requireModules.join(", ");
                if (e.originalError) {
                    var r = e.originalError.srcElement || e.originalError.originalTarget;
                    r && r.src && (t += "\n Url: " + r.src)
                }
                throw t
            }
            throw "[compSupport] RequireJS Error: " + e.message
        }))
    }
    var o = [],
        a = [],
        ...
        u = "data-component-id",
        c = "data-jscomp",
        p = "data-jscomp-config",
        d = "data-jscomp-css",
        f = "/stylesheets/";
    return {
        init: function(e) {
            require(["jquery"], function(t) {
                e = t(e ? e : "html"), e.find("*[" + c + "]").each(function() {
                    if (void 0 == t(this).attr(u)) {
                        var e = this,
                            r = t(e).attr(c),
                            i = {},
                            o = t(e).attr(p),
                        ...
                        if (o) try {
                            ...
                            throw '[compSupport] Invalid JSON configuration in HTML attribute "' + p + '" for JS component ' + r + ", malformed JSON string: " + o
                        }
                        n(r, e, i, a)
                    }
                })
        ...
        onCompEvent: function(e, t, r) {
            require(["jquery"], function(i) {
                i(function() {
                    var n = i(e).closest("*[" + c + "]");
                    if (!n) throw "[compSupport] Can't add callback for component event `" + t + "`. Component not found: " + e;
                    void 0 !== n.on ? n.on("jsComp-" + t, r) : n.bind("jsComp-" + t, r)
                })
            })
        },
        triggerCompEvent: function(t, r, i) {
            require(["jquery"], function(n) {
                n(function() {
                    var o = n(t).closest("*[" + c + "]");
                    if (void 0 === o.attr("id")) throw e("<JS_COMP_EVENT_FAILD: " + r + "> Component: #" + o.attr("id") + " (" + o.attr(c) + ")"), "[compSupport] trigger comp event not on JS component HTML";
                    e("<JS_COMP_EVENT: " + r + "> Component: #" + o.attr("id") + " (" + o.attr(c) + ")"), n(o).triggerHandler("jsComp-" + r, i || [])
                })
            })
        },
        callFunc: function(e, t, r) {
            return this.getComp(e, function(e) {
                if (!e || !e[t]) throw "[compSupport] callFunc() Can't find function name: " + t;
                e[t].apply(e, r || [])
            }, this), !1
        },
        getComp: function(e, t, r) {
            var i = this;
            require(["jquery"], function(n) {
                n(function() {
                    var a = n(e).closest("*[" + c + "]");
                    if (a) {
                        var s = a.attr(u);
                        void 0 !== s && o[s] ? t.call(r, o[s]) : i.onCompEvent(a, "init", function(e, i) {
                            t.call(r, i)
                        })
                    }
                })
